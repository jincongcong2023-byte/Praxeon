...
import (
	...
	"mars/docs"
	identitymodulekeeper "mars/x/identity/keeper"
	marsmodulekeeper "mars/x/mars/keeper"
	praxmodulekeeper "mars/x/prax/keeper"
	signalmodulekeeper "mars/x/signal/keeper"
)
...
type App struct {
	*runtime.App
	...
	PraxKeeper     praxmodulekeeper.Keeper
